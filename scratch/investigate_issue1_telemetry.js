/**
 * POLARIS — Issue 1 Distance-Over-Time Telemetry Inspection
 */

import { EpisodeRunner } from '../src/js/dataset/episodeRunner.js';
import { SCENARIO_CLASSES } from '../src/js/debug/navTestScenarios.js';

const runner = new EpisodeRunner();

console.log('=== DISTANCE-TO-DESTINATION OVER TIME TRACE ===\n');
